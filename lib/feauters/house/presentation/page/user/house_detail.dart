...
import '../../../../../core/util/env.dart';
import '../../../../auth/presentation/bloc/user_status/user_status_bloc.dart';
import '../../../../auth/presentation/bloc/user_status/user_status_event.dart';
import '../../../../auth/presentation/bloc/user_status/user_status_state.dart';
import '../../bloc/user/house/house_bloc.dart';
import '../../bloc/user/payment/payment_state.dart';
                                        ...
                                        onPressed: () async{
                                          ...
                                          if(state is StatusSuccess) {
                                            ...
                                            if(user.payment_status==1){
                                              ...
                                              final brokerProfile = houseBloc.getBrokerProfile;
                                              var broker= await brokerProfile(houseModel.brokerId.toString());
                                              print(broker);
                                              Navigator.pushNamed(context, "/brokerProfile");
                                              // return Container();
                                            }
