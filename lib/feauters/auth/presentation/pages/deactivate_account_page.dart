            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 8),
                  Text(
                    'If you successfully found a roommate, to stop receiving further recommendations and notifications, you can deactivate your account. You can reactivate your account within 12 months by logging in again.',
                  ...
                  ElevatedButton(
                    onPressed: (){
                      BlocProvider.of<DeactivateBloc>(context).add(DeactivateEvent(password: passwordController.text));
                    },
                    child: Text('Deactivate Account'),
                    style: ElevatedButton.styleFrom(
                      backgroundColor: Colors.amber, // Set button color to amber
                      minimumSize: Size(double.infinity, 48), // Make the button full-width
                    ),
                  ),
                ],
              ),
